# Generated by Django 3.1.5 on 2021-04-19 07:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='website',
            name='website_type',
            field=models.CharField(choices=[('ecommerce', 'Retailer'), ('ecommerce', 'Supplier')], default='ecommerce', max_length=100, verbose_name='Type'),
        ),
