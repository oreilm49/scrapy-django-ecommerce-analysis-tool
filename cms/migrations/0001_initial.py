    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repeat', models.CharField(choices=[('once', 'Once'), ('hourly', 'Hourly'), ('daily', 'Daily'), ('weekly', 'Weekly'), ('monthly', 'Monthly')], default='once', help_text='The frequency with which this data item should be tracked.', max_length=100, verbose_name='Repeat')),
                ('selector', models.OneToOneField(blank=True, help_text='The selector object used to extract page data.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='cms.selector', verbose_name='Selector')),
                ('unit', models.ForeignKey(blank=True, help_text='The unit of measurement for this attribute', null=True, on_delete=django.db.models.deletion.SET_NULL, to='cms.unit', verbose_name='Unit')),
                ('website', models.ForeignKey(blank=True, help_text="The website this data is specific to: for example, price may vary from website to website. If data isn't website specific, leave blank.", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='page_data_items', to='cms.website', verbose_name='Website')),
            ],
            options={
                'abstract': False,
            },
