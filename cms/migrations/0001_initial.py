    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternate_names', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=100), blank=True, null=True, size=None, verbose_name='Alternate names')),
                ('data_type', models.CharField(choices=[('int', 'Integer'), ('float', 'Float'), ('str', 'String'), ('bool', 'Boolean')], help_text='The data type of the unit', max_length=100, verbose_name='Data Type')),
                ('repeat', models.CharField(choices=[('once', 'Once'), ('hourly', 'Hourly'), ('daily', 'Daily'), ('weekly', 'Weekly'), ('monthly', 'Monthly')], default='once', help_text='The frequency with which this unit should be tracked.', max_length=100, verbose_name='Repeat')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='website_attributes', to='cms.product', verbose_name='Product')),
                ('unit', models.ForeignKey(blank=True, help_text='The data type for this attribute', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='website_product_attributes', to='cms.unit', verbose_name='Data type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(blank=True, help_text='The data type for this attribute', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product_attributes', to='cms.unit', verbose_name='Data type')),
            ],
            options={
