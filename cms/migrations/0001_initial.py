    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute_type', models.ForeignKey(blank=True, help_text='The data type for this attribute', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='websiteproductattribute', to='cms.attributetype', verbose_name='Data type')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='websiteproductattribute', to='cms.product', verbose_name='Product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', django_extensions.db.fields.ModificationDateTimeField(auto_now=True, verbose_name='modification time')),
                ('value', models.CharField(help_text='The value for this attribute', max_length=100, verbose_name='Value')),
                ('attribute_type', models.ForeignKey(blank=True, help_text='The data type for this attribute', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='productattribute', to='cms.attributetype', verbose_name='Data type')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='productattribute', to='cms.product', verbose_name='Product')),
            ],
            options={
